...
body{width: 100%;height: 100%;font-family: "Helvetica Neue", Helvetica, Arial, "PingFang SC", "Hiragino Sans GB", "Heiti SC", "Microsoft YaHei", "WenQuanYi Micro Hei", sans-serif;}
...
.red{color: #ff0000}
.border-radius5{-webkit-border-radius:5/@r; border-radius:5/@r;}
.border-radiusAll{-webkit-border-radius:50%; border-radius:50%;}
/* disBox box-flex */
...
.examList .mint-loadmore-bottom{
    font-size:28/@r;
    margin:0;
}
.examResult .mint-loadmore-bottom{font-size:16/@r}
.examOnline .el-alert{position:fixed;top:0;right:0;opacity: .85;border-radius:0;text-align:center}
.examOnline .el-alert__content{margin:0 auto;}
.f16{font-size:16/@r}
/*control txt line */
...
.lineTop:before,.lineBottom:after,.lineLeft:before,.lineRight:after,.lineList:before,.lineList:after,.lineList li:after{position: absolute;content:'';background-color:#d4d6d3;z-index:9;}
...
.linebox:after,.lineboxRadius:after{position:absolute;content:"";top:0;left:0;right:0;bottom:0;-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;width:100%;height:100%;border:1px solid #d4d6d3;}
