<template>
  <div>
      ...
      <section class="examResult relative" :style="{ '-webkit-overflow-scrolling': scrollMode,'height': wrapperHeight + 'px'}" ref="wrapper">

          <v-loadmore  :bottom-method="loadBottom" :bottom-all-loaded="allLoaded" :auto-fill="false" ref="loadmore" :bottomPullText='bottomText'  :bottomDistance = '50' style="min-height:100%">
...
.resultCon h1{font-weight: normal;color: #424959;font-size: 48/@r;line-height: 60/@r;margin-bottom: 90/@r;word-break: break-all;}
